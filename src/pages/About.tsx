...
const values = [
  { icon: Award, title: "Excellence", desc: "We never settle for ordinary. Every project is a masterpiece." },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden">
        <img src={aboutHero} alt="About Zikhra" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-end h-full px-6 pb-16 text-center">
          ...
          <p className="font-sans text-foreground/80 text-sm max-w-sm">
            Born from a passion for perfection, Zikhra transforms spaces into experiences.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding max-w-2xl mx-auto text-center">
        ...
        <p className="font-sans text-foreground/80 text-sm leading-relaxed mb-4">
          At Zikhra, we believe that interior design is not just about aesthetics — it's about creating environments that elevate the way you live. Founded in Bangalore, we've grown from a boutique studio into one of the city's most sought-after interior design firms.
        </p>
      ...
      <section className="section-padding bg-luxury-dark text-center">
        <h2 className="font-serif text-2xl gold-text mb-4">Let's Create Something Beautiful</h2>
        <a
