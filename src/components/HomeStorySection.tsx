...
const HomeStorySection = ({ market = "hyderabad", areaName }: Props) => {
  if (market === "bangalore") {
    return (
        ...
        <div className="max-w-3xl mx-auto px-5 md:px-8">
          ...
          <div className="space-y-5 font-sans text-sm md:text-base text-muted-foreground leading-relaxed">
            <p>
              ...
              premium materials, transparent milestones, and designer-led execution — to apartments, villas, and penthouses
              across the city.
            </p>
            <p>
            ...
            <p>
              ...
              maintenance. Bedrooms and wardrobes focus on quiet details — soft-close hardware, integrated lighting, and
              walk-in experiences that feel boutique.
            </p>
            <p>
              Many clients choose <strong className="text-foreground font-medium">turnkey interiors</strong>: one team for
              drawings, procurement, site coordination, and quality checks. That continuity protects your budget, reduces
              vendor confusion, and keeps the vision intact. We are equally comfortable partnering with your architect or
              builder when you already have a trusted construction team.
            </p>
            <p>
