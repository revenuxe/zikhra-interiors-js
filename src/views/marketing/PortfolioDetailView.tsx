...
export default function PortfolioDetailView({ item }: { item: PortfolioItem }) {
  return (
    <div className="min-h-screen bg-background">
      <Header />

      <section className="relative h-[70vh] w-full overflow-hidden">
        <img src={item.heroImage} alt={`${item.title} Hyderabad`} className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-end h-full px-6 pb-16 text-center">
          <Link href="/" className="absolute top-28 md:top-24 left-5 flex items-center gap-2 text-gold text-sm font-sans">
